...
<?php while ( $loop->have_posts() ) : $loop->the_post();
    ...
    $tour_url = get_field('tour_url', get_the_ID()) ? '<a class="wp-block-button__link has-dark-green-background-color virtual-tour-link" href="' . esc_url(get_field('tour_url', get_the_ID())) . '">' . esc_html_x('View Berry', 'waeg') . '</a>' : '';

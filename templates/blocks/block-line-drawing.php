...
<img class="full-width object-fit-contain max-height-600 line-drawing top-margin-40" src="<?php echo esc_url($linedrawing2['url']); ?>" alt="<?php echo esc_attr($linedrawing2['alt']); ?>" />
<?php endif;